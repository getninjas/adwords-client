...
def _build_shared_set_operations():
    ...
    adwords_operation = next(operation_builder(get_internal_operation))

    expected_adwords_operation = {
        'fields': ['Name', 'SharedSetId', 'Type', 'Status'],
    ...
    assert expected_adwords_operation == adwords_operation
...
def _build_operations_with_default_fields():
    ...
    expected_get_adwords_operation['fields'] = set(expected_get_adwords_operation['fields'])
    assert expected_get_adwords_operation == get_adwords_operation
